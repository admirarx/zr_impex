...
class MachineResource extends Resource
{
    ...
    protected static ?string $slug = 'machines';

    protected static ?string $navigationGroup = 'Products';

    protected static ?string $navigationIcon = 'heroicon-o-cpu-chip';

    protected static ?string $modelLabel = 'CNC Machine';
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                Forms\Components\Tabs::make('Machine Information')
                    ->tabs([
                                    ...
                                    ->schema([
                                        Forms\Components\Select::make('category_id')
                                            ...
                                            ->relationship('category', 'name', modifyQueryUsing: function (Builder $query) {
                                                return $query->machines()->where('is_active', true);
                                            })
                                            ->searchable()
                                            ->preload()
                                            ->required(),
        ...
        return $table
            ...
            ->filters([
                Tables\Filters\SelectFilter::make('category_id')
                    ->relationship('category', 'name', modifyQueryUsing: fn (Builder $query) => $query->machines()),
            ...
            ->actions([
                ...
                Tables\Actions\Action::make('view_public')
                    ...
                    ->color('gray')
                    ->url(fn (Product $record) => route('machines.show', $record->slug))
                    ->openUrlInNewTab(),
