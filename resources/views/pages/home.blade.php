...
<a class="inline-flex items-center gap-space-xs bg-surface-container-high hover:bg-surface-container-highest text-primary font-headline-sm text-headline-sm px-space-lg py-space-sm rounded transition-colors whitespace-nowrap" href="https://wa.me/919876543210?text=Hello,%20I%20need%20an%20urgent%20spare%20parts%20quote" rel="noopener noreferrer" target="_blank">
<span class="material-symbols-outlined text-[18px]">search</span>
<span>Find Parts By Machine Model</span>
</a>
</div>
<!-- Parts Grid -->
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-space-md">
<!-- Part 1 -->
<div class="bg-surface-container p-space-md rounded-lg shadow-sm flex flex-col justify-between">
<div>
<div class="relative h-36 rounded overflow-hidden mb-space-sm bg-surface-container-low">
<img class="w-full h-full object-cover" data-alt="Set of high precision Raytools laser cutting nozzles chrome plated and quartz protective windows on anti-static foam in manufacturing parts department" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDiB6hAUdE2EAMqVSe7ohly687jwEdrOT14MO5o-MEiBY23dhwAxaeiQYTkvL9Z4uD0iwIOsyPzzE1WnqMapJF_47-u2h5nD06MJaotM49sVgPm1CrwLP0rmLAVI0uWKIW4DES6RfbIoXt7cePQLqYpHTuFx6mwGgjf3N5gqgZSg0tWqxa8cZjoMuLzafYGn5_NuL1jOErS2VG3CmiSD1SCf4DKPtHSHYODdGaORP-5jrV4lKnSVwoJ"/>
<span class="absolute top-space-2xs right-space-2xs bg-surface-dim/90 font-label-badge text-label-badge text-primary px-space-2xs py-space-2xs rounded">RAYTOOLS SPEC</span>
</div>
<span class="font-label-caps text-label-caps text-outline uppercase block">SKU: RAY-NOZ-D1.5</span>
<h4 class="font-headline-sm text-headline-sm text-on-surface font-semibold mt-space-2xs">Laser Cut Nozzles &amp; Quartz Glass</h4>
<p class="font-body-sm text-body-sm text-on-surface-variant mt-space-2xs">Single &amp; double layer 1064nm protective optical windows.</p>
</div>
<a class="mt-space-md flex items-center justify-between text-primary hover:text-primary-fixed font-tech-spec text-tech-spec py-space-xs bg-surface-container-high px-space-sm rounded" href="https://wa.me/919876543210?text=Order%20SKU%20RAY-NOZ-D1.5" rel="noopener noreferrer" target="_blank">
<span>Order SKU</span>
<span class="material-symbols-outlined text-[16px]">arrow_forward</span>
</a>
</div>
...
<div>
<div class="relative h-36 rounded overflow-hidden mb-space-sm bg-surface-container-low">
<img class="w-full h-full object-cover" data-alt="Heavy industrial CNC electrospindle HSD Italy with ceramic bearings and air cooling collet on test bench in precision workshop" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCOYEKsPEz91AK-39FAnpbYj7vCOnUWNOBxBIIRIh0WicigGQ1jzOSGCDFl13aT78Bebmj5VGRMI2cKKAoiQsn8fi00tThOL14Hkch_RR_qunr4jBQcEWgNNKzNmA2dhTHkvZyNhMWWJYuZrLZQbgs7DrQpMr12YICb25CGMXcQH0uke76EXLYEva2B4RlBjBANgz3mwofXyV_gjCxXaE_H-nL9qDCkhdsP39GxbNORh2Or49OIaDgJ"/>
<span class="absolute top-space-2xs right-space-2xs bg-surface-dim/90 font-label-badge text-label-badge text-primary px-space-2xs py-space-2xs rounded">HSD / HQD</span>
</div>
<span class="font-label-caps text-label-caps text-outline uppercase block">SKU: SPD-HSD-6KW</span>
<h4 class="font-headline-sm text-headline-sm text-on-surface font-semibold mt-space-2xs">High-Speed Electrospindles</h4>
<p class="font-body-sm text-body-sm text-on-surface-variant mt-space-2xs">3.0kW to 9.0kW ceramic bearings for wood, stone, &amp; aluminum.</p>
</div>
<a class="mt-space-md flex items-center justify-between text-primary hover:text-primary-fixed font-tech-spec text-tech-spec py-space-xs bg-surface-container-high px-space-sm rounded" href="https://wa.me/919876543210?text=Order%20SKU%20SPD-HSD-6KW" rel="noopener noreferrer" target="_blank">
<span>Order SKU</span>
<span class="material-symbols-outlined text-[16px]">arrow_forward</span>
</a>
</div>
...
<div>
<div class="relative h-36 rounded overflow-hidden mb-space-sm bg-surface-container-low">
<img class="w-full h-full object-cover" data-alt="Hiwin Taiwan linear guide rails and heavy duty flange bearing blocks arranged in precision measurement clean room" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBeBHilBTzcEJQj61OnU-Cz8z1oh8yxdfObW7O8CwCAa41wh7j918WJtXDNSa94yV5YRJvxy_8FmcGp95dwtqNx6CAQWTA0o9A2deak48LL-DY5H8RKQZFYum0yYHPayX0iB1gzo5CXmatA7tl0y7KvNUe8fHmgtE28oOqiNyaFeYgl7dwetBeLM8aq8ZfmkerGEwuqXhagG1VMoiOqWD8nG1JGFkwINARSaSaMyMekMXobjuW6v0ZM"/>
<span class="absolute top-space-2xs right-space-2xs bg-surface-dim/90 font-label-badge text-label-badge text-primary px-space-2xs py-space-2xs rounded">HIWIN TAIWAN</span>
</div>
<span class="font-label-caps text-label-caps text-outline uppercase block">SKU: HWN-HGR25-CA</span>
<h4 class="font-headline-sm text-headline-sm text-on-surface font-semibold mt-space-2xs">Linear Guide Rails &amp; Flanges</h4>
<p class="font-body-sm text-body-sm text-on-surface-variant mt-space-2xs">Genuine HGR20 / HGR25 blocks with self-lubricating wipers.</p>
</div>
<a class="mt-space-md flex items-center justify-between text-primary hover:text-primary-fixed font-tech-spec text-tech-spec py-space-xs bg-surface-container-high px-space-sm rounded" href="https://wa.me/919876543210?text=Order%20SKU%20HWN-HGR25-CA" rel="noopener noreferrer" target="_blank">
<span>Order SKU</span>
<span class="material-symbols-outlined text-[16px]">arrow_forward</span>
</a>
</div>
...
<div>
<div class="relative h-36 rounded overflow-hidden mb-space-sm bg-surface-container-low">
<img class="w-full h-full object-cover" data-alt="BJJCZ EzCad3 laser controller motherboard circuit board with fiber laser optic data cables connected in clean calibration lab" src="https://lh3.googleusercontent.com/aida-public/AB6AXuA3zZBPOufez18OWP4ku3XaqgC4hgiqKBmkeyrce9TEpXHEKAPGOBb7-tYQ6JpoRwLeH5bK_MJg07TFTmh4jtFkcuFg1xrYAs0w2kZl6dV2yLIIYhb6kb5XrB-UV2yNZH6Sm633Fc4WTLIhvYOe8gH7MknRbvzI2LgXKzIOKVJ1E9A7kXLNW90DIPE8RGcf7zzpUg_A3zLJXJYwO3WUNFf2g3xQN_V2cx_RnRjBcpVAhkegD6KcqwNl"/>
<span class="absolute top-space-2xs right-space-2xs bg-surface-dim/90 font-label-badge text-label-badge text-primary px-space-2xs py-space-2xs rounded">BJJCZ ORIGINAL</span>
</div>
<span class="font-label-caps text-label-caps text-outline uppercase block">SKU: CTL-JCZ-V4</span>
<h4 class="font-headline-sm text-headline-sm text-on-surface font-semibold mt-space-2xs">EzCad2 / EzCad3 Motherboards</h4>
<p class="font-body-sm text-body-sm text-on-surface-variant mt-space-2xs">USB / Ethernet marking controllers with encrypted driver dongles.</p>
</div>
<a class="mt-space-md flex items-center justify-between text-primary hover:text-primary-fixed font-tech-spec text-tech-spec py-space-xs bg-surface-container-high px-space-sm rounded" href="https://wa.me/919876543210?text=Order%20SKU%20CTL-JCZ-V4" rel="noopener noreferrer" target="_blank">
<span>Order SKU</span>
<span class="material-symbols-outlined text-[16px]">arrow_forward</span>
</a>
</div>
...
<div>
<div class="relative h-36 rounded overflow-hidden mb-space-sm bg-surface-container-low">
<img class="w-full h-full object-cover" data-alt="Telecentric F-Theta quartz scanning lens for fiber laser marking machine reflecting green laser light on precision mount" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCLtC37m0p7dIDAH0o-l0WmAmajj343SMmUPfqsYBE370lbIZbmVMQEQ7h14I5FmLjyv1Z_BMPKtGxDvi1LUDGOABjvgq5RTAXC4ctotbezPpgeO-7lxkhwZjYk2DPO2RaWopTAFF8FhM5eBOfTL8FZzklW_6mvI_yv4MJepDujMb2VFd2D-AG1D5aKiVQYMfCl-wmJmeO0eeQlIHmcYmgB3S78CGwZLgvOp3GteyMpn73-EvJOk1iq"/>
<span class="absolute top-space-2xs right-space-2xs bg-surface-dim/90 font-label-badge text-label-badge text-primary px-space-2xs py-space-2xs rounded">F-THETA OPTO</span>
</div>
<span class="font-label-caps text-label-caps text-outline uppercase block">SKU: LNS-FTH-110</span>
<h4 class="font-headline-sm text-headline-sm text-on-surface font-semibold mt-space-2xs">F-Theta Scanning Lenses</h4>
<p class="font-body-sm text-body-sm text-on-surface-variant mt-space-2xs">110x110mm to 300x300mm field scan quartz lenses, M85 thread.</p>
</div>
<a class="mt-space-md flex items-center justify-between text-primary hover:text-primary-fixed font-tech-spec text-tech-spec py-space-xs bg-surface-container-high px-space-sm rounded" href="https://wa.me/919876543210?text=Order%20SKU%20LNS-FTH-110" rel="noopener noreferrer" target="_blank">
<span>Order SKU</span>
<span class="material-symbols-outlined text-[16px]">arrow_forward</span>
</a>
</div>
