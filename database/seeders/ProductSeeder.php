...
class ProductSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $catOptics = Category::where('slug', 'laser-optics-and-nozzles')->first();
        $catChillers = Category::where('slug', 'industrial-water-chillers')->first();
        ...
        $machines = [
            [
                ...
                'sort_order' => 1,
                'key_features' => [
                    'Thick-walled seamless welded steel gantry annealed at 600°C for zero thermal distortion.',
                    'Authentic 3.5 kW / 4.5 kW HQD air-cooled high-speed spindle (up to 24,000 RPM).',
                    'T-slot dual-use composite vacuum suction bed with multi-zone control.',
                    'German helical rack & pinion drive on X/Y axes with ±0.025 mm repositioning repeatability.',
                    'Taiwan Hiwin 20mm heavy-duty square linear rails with dust-proof scrapers.',
                    'RichAuto DSP handheld offline controller with USB execution & power-loss memory.',
                ],
                'applications' => [
                    ['title' => 'Solid Wood & Furniture', 'description' => 'Cabinet doors, dining tables, bed posts, and intricate relief carving.'],
                    ['title' => 'Signage & Advertising', 'description' => '3D acrylic channel letters, ACP facade sheets, PVC boards, and foam cutouts.'],
                    ['title' => 'Architectural Jali & Panels', 'description' => 'Precision patterned wall partitions, MDF grilles, and decorative screens.'],
                    ['title' => 'Aluminium & Non-Ferrous', 'description' => 'Aluminium composite cladding, brass plates, and soft alloy milling.'],
                ],
                'benefits' => [
                    ['title' => 'Heavy Rigidity Bed', 'description' => 'Stress-relieved solid steel frame prevents vibration under heavy feed rates.'],
                    ['title' => 'High Output & Speed', 'description' => 'Rapid traverse speed up to 35 m/min for accelerated production runs.'],
                    ['title' => 'Low Maintenance', 'description' => 'Automatic central lubrication and sealed dust-protected linear rails.'],
                    ['title' => 'Turnkey Commissioning', 'description' => 'Factory assembled, tested, and shipped ready for instant plant operation.'],
                ],
                'specs' => [
        ...
        $spareParts = [
            [
                ...
                'primary_image' => 'https://lh3.googleusercontent.com/aida-public/AB6AXuCZemjI9_gZJBjKyHn-b_gaQKooPyvrYYD34Wcj-DSXHau2WcyrEtoaO2XJKTmoMqzXCPjQ2vW7eV-jymtnV1J4PhyOKlKxH6yXGby1wYsEo0GDNCdGpmkyH9tMpDeerO08_xpDICurw_ZUETbqkCtKoAzX3aZw8j8FzJpXhN2Pzt6dcxUFHPTa0JNBK4gYtMh777IfNkPwXk-W_i2FQlwT9gMwAkF-dS_-a6mTfw8pEmHIgGHc8K1e',
                'is_featured' => true,
                'is_published' => true,
                'sort_order' => 1,
            ...
            [
                ...
                'primary_image' => 'https://lh3.googleusercontent.com/aida-public/AB6AXuDvzeIcXPa331TguweR53RdB58OCueiWMp0OvuF74jMw2ebu0ZBLJ3ExA3fYfvzuKKw5ZYwY-f33oSAsECeb5pI-M-assWuN7TGsl4D-8r-77B4j9vYfGJkjWQWgUioBYgjbsoInvfW4SrvzGxTe0MWKz_Y-oqTscpHwA6hYUwXBnmV6oZYw3qRdLGxO6QXOUtetGeg6-JCqYA6_0t87GKbU0P5XyAvYGCiEYz80WBl73L1TNHdXxM8',
                'is_featured' => true,
                'is_published' => true,
                'sort_order' => 5,
                'compatible_with' => ['ZR-1325-PRO', 'ZR-4H-1325'],
            ...
            [
                ...
                'primary_image' => 'https://lh3.googleusercontent.com/aida-public/AB6AXuBU6v-g60q0w9Gg1BC2WnUynRSIThjeS2EVo1VpntyYc213une_M_E9E2OR0tmIbSAph4v0cwmfrERkMmuhTMBvH0hlHdaywxPgXcmBGUIeU5FGCMbqta2EWAtTT_Y4oowCDFB5iRrJMq4SgjYu0sd-hqSaF9zZC9PSmSKJmkE1AfehQiT_Gjtbug2Lrjb4mlwTc-krQT8cZPDmHtASJEwqXbV-VQpOJct-3S5W0dcsmE_Z511aWyQy',
                'is_featured' => false,
                'is_published' => true,
                'sort_order' => 6,
                'compatible_with' => ['ZR-1325-PRO', 'ZR-4H-1325'],
            ...
            [
                'category_id' => $catOptics?->id,
                'type' => 'spare_part',
                'name' => 'Raytools Dual-Layer Laser Cutting Nozzle Ø1.5mm',
                'model_number' => 'RAY-NOZ-D1.5',
                'slug' => 'raytools-dual-layer-fiber-laser-nozzle',
                'short_description' => 'Original Raytools double-layer chrome-plated copper nozzle for fiber laser cutting heads BM111 and BM114. Ultra wear-resistant with stable gas flow.',
                'description' => '<p>Direct-factory genuine Raytools dual-layer cutting nozzle crafted from electrolytic T2 copper with high-purity chrome electroplating. Engineered for high-pressure nitrogen and oxygen assist gas cutting with zero spatter adhesion.</p>',
                'primary_image' => 'https://lh3.googleusercontent.com/aida-public/AB6AXuBG9prkoW0M5g0BAfYmee02cX6ty6TQ34tdAjhSG9riWgATusrYaQEBwa_0sQqa08os7jRk35h5m9zIVix2LM-drulA-2-8e4MAymCXPPYwzkyFbQDUOAb0SBhp_dzCXbWUt7OsvA1siM4gyB3UdJGyIpG1My6diPeoDSqz8z-DStmqdTk85QHq5LFSxr0eHGG0seV0-z4GQF0jkPL49hAEmNWq5y846qL-YSlh-73Knp_Ss4JzF3nP',
                'is_featured' => true,
                'is_published' => true,
                'sort_order' => 7,
                'compatible_with' => ['ZR-1530-FL', 'ZR-FSC-6000'],
                'specs' => [
                    ['spec_group' => 'Optics Spec', 'spec_name' => 'Nozzle Orifice', 'spec_value' => 'Ø1.5 mm (Double Layer)', 'sort_order' => 1],
                    ['spec_group' => 'Compatibility', 'spec_name' => 'Laser Cutting Head', 'spec_value' => 'Raytools BM111 / BM114 / BM109', 'sort_order' => 2],
                    ['spec_group' => 'Mechanical', 'spec_name' => 'Thread Size', 'spec_value' => 'M11 / M14 Standard', 'sort_order' => 3],
                    ['spec_group' => 'Material', 'spec_name' => 'Body Composition', 'spec_value' => 'T2 Electrolytic Copper + Chrome Plated', 'sort_order' => 4],
                    ['spec_group' => 'Performance', 'spec_name' => 'Gas Suitability', 'spec_value' => 'High-Pressure N2 / O2 / Clean Air', 'sort_order' => 5],
                ],
            ],
            [
                'category_id' => $catChillers?->id,
                'type' => 'spare_part',
                'name' => 'S&A CW-5200 Dual-Inlet Industrial Water Chiller (1400W)',
                'model_number' => 'SA-CW5200',
                'slug' => 'sa-cw5200-dual-inlet-industrial-chiller',
                'short_description' => 'Original S&A Teyu CW-5200 high-precision industrial water chiller. 1.4kW cooling capacity with ±0.3°C temperature stability for fiber lasers and spindles.',
                'description' => '<p>The genuine S&A CW-5200 series provides intelligent dual-temperature control modes, flow alarms, and over-temperature safety cutoffs. Ensures continuous optical stabilization for fiber laser cutters and high-RPM router spindles.</p>',
                'primary_image' => 'https://lh3.googleusercontent.com/aida-public/AB6AXuBVK3bZLRZ4xmWLhlKsxfN8gZ3R6jIaDvEn340lZYTg5A61JRcKGG62Nd0-ocRhs-4AaCP__izprS21MBGIuoEvqIcxzYpCZAvqVMR6yNwrpveLWNFrAEjWKQ_ilfySK1P0MqXSzb-hiVI-lmW1sgdzi9js4gKB03CY9glMJMfglFwNt5kw29ZqouYzj9w3tJbZOcC0bEeX-jLuEwGUdmkBJ1U6in2yLSHbLIF4sm4aCPypVWmVpVzG',
                'is_featured' => true,
                'is_published' => true,
                'sort_order' => 8,
                'compatible_with' => ['ZR-1530-FL', 'ZR-1390-CO2', 'ZR-1325-PRO'],
                'specs' => [
                    ['spec_group' => 'Thermodynamic', 'spec_name' => 'Cooling Capacity', 'spec_value' => '1.43 kW (4,879 Btu/h)', 'sort_order' => 1],
                    ['spec_group' => 'Precision', 'spec_name' => 'Temperature Stability', 'spec_value' => '±0.3 °C High Precision', 'sort_order' => 2],
                    ['spec_group' => 'Refrigeration', 'spec_name' => 'Refrigerant Charge', 'spec_value' => 'R-410a Eco-Friendly (360g)', 'sort_order' => 3],
                    ['spec_group' => 'Hydraulic', 'spec_name' => 'Tank & Pump Flow', 'spec_value' => '6L Reservoir | 13 L/min Max Flow', 'sort_order' => 4],
                    ['spec_group' => 'Electrical', 'spec_name' => 'Operating Voltage', 'spec_value' => 'AC 220V - 240V, 50Hz', 'sort_order' => 5],
                ],
            ],
        ];
